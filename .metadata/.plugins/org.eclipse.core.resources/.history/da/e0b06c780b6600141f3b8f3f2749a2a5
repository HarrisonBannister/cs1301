...
public class Adventure {
	...
	public static void provideAnswer(String playerInput) {
		
		Scanner sc =  new Scanner(System.in);
		// makes sure input is valid
		while (Adventure.checkForValidInput(playerInput)) {
			System.out.println("Please enter another command:");
			playerInput = sc.next();
		}
		sc.close();
		
		// does appropriate actions/responses to a player's input
