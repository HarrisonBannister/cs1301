...
public class CopyOfPerson {
	...
	CopyOfPerson(int age, String name, boolean isFemale) {
		totalPersons++;
		if (isFemale == true) {
			totalFemales++;
		}
	 ...
	 * Procedures
	 */
	public static void toString(CopyOfPerson person) {
	 ...
	 * Functions
	 */
	public boolean equals(CopyOfPerson person) {
	...
	public boolean isYounger(CopyOfPerson person) {
